//! Domain policy for Registration aggregate
//!
...
/// Domain policy for Registration — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<Registration>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RegistrationDomainPolicy = PermitAllPolicy<Registration>;
