//! Domain policy for TypeMail aggregate
//!
...
/// Domain policy for TypeMail — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<TypeMail>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type TypeMailDomainPolicy = PermitAllPolicy<TypeMail>;
