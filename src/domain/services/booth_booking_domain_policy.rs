//! Domain policy for BoothBooking aggregate
//!
...
/// Domain policy for BoothBooking — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<BoothBooking>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type BoothBookingDomainPolicy = PermitAllPolicy<BoothBooking>;
