//! Domain policy for LeadProvenanceRegistration aggregate
//!
...
/// Domain policy for LeadProvenanceRegistration — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<LeadProvenanceRegistration>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type LeadProvenanceRegistrationDomainPolicy = PermitAllPolicy<LeadProvenanceRegistration>;
