//! Domain policy for MailSlot aggregate
//!
...
/// Domain policy for MailSlot — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailSlot>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailSlotDomainPolicy = PermitAllPolicy<MailSlot>;
