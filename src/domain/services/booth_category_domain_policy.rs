//! Domain policy for BoothCategory aggregate
//!
...
/// Domain policy for BoothCategory — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<BoothCategory>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type BoothCategoryDomainPolicy = PermitAllPolicy<BoothCategory>;
