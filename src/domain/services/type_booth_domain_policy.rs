//! Domain policy for TypeBooth aggregate
//!
...
/// Domain policy for TypeBooth — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<TypeBooth>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type TypeBoothDomainPolicy = PermitAllPolicy<TypeBooth>;
