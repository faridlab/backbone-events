//! Domain policy for RegistrationQuestion aggregate
//!
...
/// Domain policy for RegistrationQuestion — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<RegistrationQuestion>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RegistrationQuestionDomainPolicy = PermitAllPolicy<RegistrationQuestion>;
