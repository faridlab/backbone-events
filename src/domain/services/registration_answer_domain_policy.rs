//! Domain policy for RegistrationAnswer aggregate
//!
...
/// Domain policy for RegistrationAnswer — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<RegistrationAnswer>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type RegistrationAnswerDomainPolicy = PermitAllPolicy<RegistrationAnswer>;
