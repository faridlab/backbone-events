//! Domain policy for EventAuditLog aggregate
//!
...
/// Domain policy for EventAuditLog — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EventAuditLog>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EventAuditLogDomainPolicy = PermitAllPolicy<EventAuditLog>;
