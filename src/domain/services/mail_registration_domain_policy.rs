//! Domain policy for MailRegistration aggregate
//!
...
/// Domain policy for MailRegistration — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<MailRegistration>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type MailRegistrationDomainPolicy = PermitAllPolicy<MailRegistration>;
