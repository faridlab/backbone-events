//! Domain policy for EventType aggregate
//!
...
/// Domain policy for EventType — permits all operations (no business invariants).
///
...
/// enforcement, implement `backbone_core::ServiceLifecycle<EventType>` on a custom
/// service. `PermitAllPolicy` is the safe default until then.
pub type EventTypeDomainPolicy = PermitAllPolicy<EventType>;
