//! Specifications for LeadProvenance aggregate
//!
...
// Each predicate implements `Specification<LeadProvenance>` and can be combined
...
//
// pub struct ActiveLeadProvenanceSpec;
// impl Specification<LeadProvenance> for ActiveLeadProvenanceSpec {
//     fn is_satisfied_by(&self, e: &LeadProvenance) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
