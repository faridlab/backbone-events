//! Specifications for EventType aggregate
//!
...
// Each predicate implements `Specification<EventType>` and can be combined
...
//
// pub struct ActiveEventTypeSpec;
// impl Specification<EventType> for ActiveEventTypeSpec {
//     fn is_satisfied_by(&self, e: &EventType) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
