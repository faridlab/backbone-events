//! Specifications for MailSlot aggregate
//!
...
// Each predicate implements `Specification<MailSlot>` and can be combined
...
//
// pub struct ActiveMailSlotSpec;
// impl Specification<MailSlot> for ActiveMailSlotSpec {
//     fn is_satisfied_by(&self, e: &MailSlot) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
