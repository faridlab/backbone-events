//! Specifications for Booth aggregate
//!
...
// Each predicate implements `Specification<Booth>` and can be combined
...
//
// pub struct ActiveBoothSpec;
// impl Specification<Booth> for ActiveBoothSpec {
//     fn is_satisfied_by(&self, e: &Booth) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
