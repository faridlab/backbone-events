//! Specifications for BoothBooking aggregate
//!
...
// Each predicate implements `Specification<BoothBooking>` and can be combined
...
//
// pub struct ActiveBoothBookingSpec;
// impl Specification<BoothBooking> for ActiveBoothBookingSpec {
//     fn is_satisfied_by(&self, e: &BoothBooking) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
