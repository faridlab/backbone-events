//! Specifications for Event aggregate
//!
...
// Each predicate implements `Specification<Event>` and can be combined
...
//
// pub struct ActiveEventSpec;
// impl Specification<Event> for ActiveEventSpec {
//     fn is_satisfied_by(&self, e: &Event) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
