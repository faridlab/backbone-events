//! Specifications for Ticket aggregate
//!
...
// Each predicate implements `Specification<Ticket>` and can be combined
...
//
// pub struct ActiveTicketSpec;
// impl Specification<Ticket> for ActiveTicketSpec {
//     fn is_satisfied_by(&self, e: &Ticket) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
