//! Specifications for BoothCategory aggregate
//!
...
// Each predicate implements `Specification<BoothCategory>` and can be combined
...
//
// pub struct ActiveBoothCategorySpec;
// impl Specification<BoothCategory> for ActiveBoothCategorySpec {
//     fn is_satisfied_by(&self, e: &BoothCategory) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
