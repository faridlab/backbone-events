//! Specifications for LeadRequest aggregate
//!
...
// Each predicate implements `Specification<LeadRequest>` and can be combined
...
//
// pub struct ActiveLeadRequestSpec;
// impl Specification<LeadRequest> for ActiveLeadRequestSpec {
//     fn is_satisfied_by(&self, e: &LeadRequest) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
