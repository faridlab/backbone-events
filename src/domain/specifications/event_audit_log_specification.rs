//! Specifications for EventAuditLog aggregate
//!
...
// Each predicate implements `Specification<EventAuditLog>` and can be combined
...
//
// pub struct ActiveEventAuditLogSpec;
// impl Specification<EventAuditLog> for ActiveEventAuditLogSpec {
//     fn is_satisfied_by(&self, e: &EventAuditLog) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
