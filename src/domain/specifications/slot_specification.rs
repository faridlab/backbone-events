//! Specifications for Slot aggregate
//!
...
// Each predicate implements `Specification<Slot>` and can be combined
...
//
// pub struct ActiveSlotSpec;
// impl Specification<Slot> for ActiveSlotSpec {
//     fn is_satisfied_by(&self, e: &Slot) -> bool {
//         // e.is_active
//         todo!()
//     }
// }
