...
--
-- This file contains initial seed data for the event.tags table.
-- Customize this file to add your initial data.

-- INSERT INTO event.tags (
--     id,
--     name,
--     category_id,
--     color,
...
-- INSERT INTO event.tags (id, code, name, is_active, created_at, updated_at) VALUES
