...
--
-- This file contains initial seed data for the event.stages table.
-- Customize this file to add your initial data.

-- INSERT INTO event.stages (
--     id,
--     name,
--     sequence,
--     fold,
...
-- INSERT INTO event.stages (id, code, name, is_active, created_at, updated_at) VALUES
