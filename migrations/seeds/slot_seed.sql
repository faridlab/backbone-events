...
--
-- This file contains initial seed data for the event.slots table.
-- Customize this file to add your initial data.

-- INSERT INTO event.slots (
--     id,
--     event_id,
--     name,
--     date_begin,
...
-- INSERT INTO event.slots (id, code, name, is_active, created_at, updated_at) VALUES
