...
--
-- This file contains initial seed data for the event.type_booths table.
-- Customize this file to add your initial data.

-- INSERT INTO event.type_booths (
--     id,
--     event_type_id,
--     booth_category_id,
--     name,
...
-- INSERT INTO event.type_booths (id, code, name, is_active, created_at, updated_at) VALUES
